...
export const modes = {
  henry: {
    ...
    labels: {
      play: 'Play as Henry',
      sandbox: '🧪 MAD MIX (Sandbox)',
      sandboxTitle: '🧪 MAD MIX — Sandbox Lab',
      sandboxGoal: 'Mix anything! {secretCount} secret recipes are hiding in here.',
      sandboxPrompt: 'Drop in any ingredients and try any tools — secret recipes are hiding!',
      sandboxObservationHeading: 'Try Anything!',
      levelTitle: "Henry's Wild Lab Cards",
      labIngredients: '2. Grab Ingredients',
      labTools: '3. Lab Tools',
      toolHint: 'Tools change cause and effect.',
      meterLabel: 'Chaos Meter',
      mixButton: 'MIX!',
      predictionLabel: '1. Predict — bonus ⭐ if right!',
      observationHeading: 'Observation Clues',
    },
  },
  pauling: {
    id: 'pauling',
    ...
    labels: {
      play: 'Study with Linus Pauling',
      sandbox: '🔬 Open Exploration',
      sandboxTitle: '🔬 Open Exploration — Sandbox Investigation',
      sandboxGoal: 'Explore variables freely. {secretCount} open-ended reaction models can be discovered.',
      sandboxPrompt: 'Select reagents and procedure tools freely, then record the evidence you observe.',
      sandboxObservationHeading: 'Open Investigation Notes',
      levelTitle: 'Linus Pauling Scientific Investigations',
      labIngredients: '2. Materials',
      labTools: '3. Procedure / Tool Step',
      toolHint: 'Procedure tools test one variable at a time.',
      meterLabel: 'Evidence Meter',
      mixButton: 'Run Trial',
      predictionLabel: '1. Hypothesis',
      observationHeading: '4. Observations',
    },
  },
};
